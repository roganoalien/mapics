		...
		<div className="w-full flex flex-col items-start justify-start text-mBlack mt-8">
			...
			<div className="w-full flex items-center justify-between">
				<div className="w-auto flex items-center justify-start">
					<div className="group flex flex-col items-start justify-start cursor-pointer">
						<div className="flex items-center justify-center">
							<p className="font-bold text-4xl group-hover:text-main transition duration-150 ease-in-out">
								18.1k
							</p>
						...
						<p className="text-md group-hover:text-main transition duration-150 ease-in-out">
							Vistas
						</p>
					</div>

					<div className="group flex flex-col items-start justify-start cursor-pointer ml-12">
						<div className="flex items-center justify-center">
							<p className="font-bold text-4xl group-hover:text-[#4140FF] transition duration-150 ease-in-out">
								1.5k
							</p>
							<p className="text-xs flex items-center justify-start ml-2">
						...
						<p className="text-md group-hover:text-[#4140FF] transition duration-150 ease-in-out">
							Visitantes
						</p>
					</div>
				...
				<div className="w-auto">
					...
					<select
						id="location"
						name="location"
						className="mt-1 block w-[150px] pl-3 pr-10 py-2 text-base border-2 font-bold focus:text-main border-mBlack focus:outline-none focus:ring-0 focus:border-main sm:text-sm rounded-md"
					>
